// Allowlist file at <project>/.agents/skill-state/ios-qa-allowlist.json. The single source of
...
export function defaultAllowlistPath(): string {
  return process.env.STANDALONE_IOS_ALLOWLIST_PATH
    ?? join(process.env.STANDALONE_SKILL_STATE ?? resolve(import.meta.dir, '../../../../..', '.agents', 'skill-state'), 'ios-qa-allowlist.json');
}
