...
// <project>/.agents/skill-state/ios-qa-daemon.pid on startup. Second invocation discovers the
...
export function defaultPidfilePath(): string {
  return process.env.STANDALONE_IOS_DAEMON_PIDFILE
    ?? join(process.env.STANDALONE_SKILL_STATE ?? resolve(import.meta.dir, '../../../../..', '.agents', 'skill-state'), 'ios-qa-daemon.pid');
}
