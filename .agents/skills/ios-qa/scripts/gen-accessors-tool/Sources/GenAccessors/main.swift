...
// <project>/.agents/skill-state/cache/gen-accessors/<hash>/StateAccessor.swift.
...
struct GenAccessors {
    static func main() async {
        ...
        let stateRoot = ProcessInfo.processInfo.environment["STANDALONE_SKILL_STATE"]
            ?? "\(FileManager.default.currentDirectoryPath)/.agents/skill-state"
        let cacheDir = "\(stateRoot)/cache/gen-accessors"
