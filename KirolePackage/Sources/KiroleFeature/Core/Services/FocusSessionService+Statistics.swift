...
extension FocusSessionService {
    ...
    func computeHistoricalFocusTimes() async -> (week: TimeInterval, month: TimeInterval) {
    ...
    func computePeakFocusHour(sessions: [FocusSession], calendar: Calendar) -> Int? {
    ...
    func computeTrendDirection() async -> TrendDirection {
