...
// Simulated device + wire parsers. The fixture *data* lives in BLEProtocolTestFixtures.swift
// (split to keep both files inside the repo's 800-line ceiling).
    ...
    func parseDayPack() throws -> SimulatedDayPack {
        ...
        for _ in 0..<eventCount {
            events.append(.init(
                ...
                // v2.10.0: per-event SupportText after EndTime (mirror encodeDayPack).
