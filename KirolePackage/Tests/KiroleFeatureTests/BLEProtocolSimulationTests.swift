...
struct BLEProtocolSimulationTests {
    ...
    func virtualHardwareReassemblesChunkedPagePayloads() throws {
        ...
        #expect(parsedDayPack.morningGreeting == "Morning, B.")
        #expect(parsedDayPack.dailySummary == "Two tasks and one hardware sync.")
        #expect(parsedDayPack.firstItem == "Plan BLE")
        #expect(parsedDayPack.currentScheduleSummary == "09:30 HW Sync")
        #expect(parsedDayPack.companionPhrase == "Small steps count.")
