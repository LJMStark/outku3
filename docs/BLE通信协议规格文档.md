...
**版本:** v2.17.0
**更新日期:** 2026-08-04
**状态:** **本版是一次合并发布**——把 2026-08-04 当天的全部内部迭代并入 v2.17.0 一次交付，那些中间编号未曾对固件单独发布，**请不要逐版对照**。固件上一个收到的版本是 **v2.10.2**；若你尚未施工 v2.16.0，请按 v2.10.2 → v2.17.0 的整体差异一次做完（v2.16.0 自身也是一次合并发布，其中的 v2.11.0–v2.15.0 同理）。
