...
export async function GET() {
  return Response.json({
    ...
    characters: promptSpecSource.characters.map(({ id, displayName, displayNameZh, virtue, wordLimits, approvedQuotes }) => ({ id, displayName, displayNameZh, virtue, wordLimits, approvedQuotes })),
